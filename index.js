...
client.user.setActivity(`DePiedra | ` + client.guilds.cache.size + ` Sunucu | ` + client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ` Kullanıcı`, { type: 'LISTENING' });
});
client.login(fynx.fynxtoken)
.then(function() {
console.log('[DePiedra] Token doğru. Bot aktif ediliyor.')
}, function(err) {
